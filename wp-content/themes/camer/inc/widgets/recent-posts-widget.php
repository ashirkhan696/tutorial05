 ...
 * Recent posts class.
 */
class Camer_Recent_Posts_Widget extends WP_Widget {
	/**
	...
	public function __construct() {
		$this->defaults = array(
			'title'     => esc_html__( 'Camer Recent Posts', 'camer' ),
			'number'    => 3,
			'show_date' => true,
		);
		parent::__construct(
			'camer-recent-posts',
			esc_html__( 'Camer Recent Posts', 'camer' ),
			array(
				'description' => esc_html__( 'A widget that displays your recent posts from all categories or a category with thumbnails.', 'camer' ),
			)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		?>
<ul class="camer-recent-posts-widget">
    ...
    <li class="rp-item">
        ...
        <figure class="rp-thumbnail">
            <a class="rp-image-link" href="<?php esc_url(the_permalink()); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>">
                <?php the_post_thumbnail( 'camer-recent-thumbnail' ); ?>
            </a>
        </figure>
        ...
        <figure class="rp-thumbnail">
            <a class="rp-image" href="<?php esc_url(the_permalink()); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>">
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/no-recent.png" alt="<?php esc_html_e( 'No Image', 'camer');?>" />
            </a>
        </figure>
...
<p>
    <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>">
        <?php esc_html_e( 'Title:', 'camer' ); ?></label>
    <input type="text" class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" value="<?php echo esc_attr( $instance['title'] ); ?>">
</p>
<p>
    <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>">
        <?php esc_html_e( 'Number of posts to show:', 'camer' ); ?></label>
